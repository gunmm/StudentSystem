				...
				<div id="mainPanel">
					...
					<div id="right">
						<form action="<%=path%>/users/User_login.action" method="post">
							...
							<div id="pass-word">
								<span class="item">密&nbsp;&nbsp;&nbsp;码:</span> <input
									type="password" name="password" class="form-input">
							</div>

							<div id="button-group">
								<input id="btnn" type="submit" class="btn" value="登录" /> <input
									type="reset" class="btn" value="重置" />
							</div>
							<div>
								<s:fielderror name="usernameError"></s:fielderror>
								<s:fielderror name="passwordError"></s:fielderror>
